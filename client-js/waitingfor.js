...
(function (root, factory) {
    ...
    function constructDialog($dialog) {
        ...
        return $(
            ...
            '<div role="progressbar" class="progress-bar progress-bar-striped progress-bar-animated" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '</div>' +
    ...
    return {
        ...
        show: function (message, options) {
            ...
            // Opening dialog
            $dialog.slist = [() => $dialog.shown = true];
            $dialog.modal('show').on('shown.bs.modal', function() {
                $dialog.slist.forEach(x => x());
            });
        },
        /**
         * Closes dialog
